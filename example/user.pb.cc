...
void RegisterResponse::SerializeWithCachedSizes(
  ...
  // bool sucess = 2;
  if (this->sucess() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBool(2, this->sucess(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* RegisterResponse::InternalSerializeWithCachedSizesToArray(
  ...
  // bool sucess = 2;
  if (this->sucess() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(2, this->sucess(), target);
  }
